                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker articuloB" data-live-search="true"
                                    name="id_material" id="id_material" lang="es" autofocus>
                                    <option value="" disabled selected>Buscar Materiales</option>
                                    @foreach ($materialesOptions as $value => $description)
                        ...
                        <div class="form-group col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="cantidad" id="cantidad"
                                    aria-describedby="helpId" min="0" max="10000"
                        ...
                        <div class="form-group col-md-2 mt-4">
                            <div class="form-group mt-2">
                                <button type="button" id="agregar" class="btn btn-info float-right"
                                    onclick="agregarMaterial()">Agregar
                                    Material</button>
                            </div>
                        </div>
                    </div>
...
@section('js')
    ...
    <script>
        function agregarMaterial() {
            ...
            var materialDescripcion = $('#id_material option:selected').text();
          ...
          <tr>
            ...
            <td>${materialDescripcion}<input type="hidden" name="id_material[]" value="${materialId}"></td>            
