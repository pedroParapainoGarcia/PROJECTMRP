...
@section('content')
    ...
    @can('admin.cliente.create')
        <a class="btn btn-primary mb-3" href="{{ route('admin.cliente.create') }}">CREAR</a>
    @endcan

    <table id="cliente" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
