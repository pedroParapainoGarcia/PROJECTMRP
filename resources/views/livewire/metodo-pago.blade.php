                ...
                <section class="bg-white rounded shadow-lg mb-12">
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex" wire:ignore>
                            ...
                            <div class="flex-1">
                                <input id="card-holder-name" class="form-control mb-4"
                                    placeholder="Nombre del titular de la targeta">
                                ...
                                @foreach ($paymentMethods as $paymentMethod)
                                    <li class="py-2 flex justify-between" wire:key="{{ $paymentMethod->id }}">
                                        ...
                                        <div>
                                            <p>
                                                <span
                                                    class="font-semibold">{{ $paymentMethod->billing_details->name }}</span>
